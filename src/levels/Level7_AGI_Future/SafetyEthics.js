...
/* ══════════════════════════════════════════════════════════════════
   SAFETY & ETHICS
   Level 7 · Level7 AGI Future · Lesson 4 of 5
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function SafetyEthics({ onBack }) {
  const ACC = "#0891b2";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 4 of 5 · Level 7</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>Safety & Ethics</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"Safety & Ethics"</strong> with beginner
