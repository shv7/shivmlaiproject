...
/* ══════════════════════════════════════════════════════════════════
   ...
   Level 7 · Level7 AGI Future · Lesson 1 of 5
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function ArtificialGeneralIntelligence({ onBack }) {
  const ACC = "#ef4444";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 1 of 5 · Level 7</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>Artificial General Intelligence</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"Artificial General Intelligence"</strong> with beginner
