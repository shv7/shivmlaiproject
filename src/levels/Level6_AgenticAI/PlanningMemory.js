...
/* ══════════════════════════════════════════════════════════════════
   PLANNING & MEMORY
   Level 6 · Level6 AgenticAI · Lesson 2 of 5
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function PlanningMemory({ onBack }) {
  const ACC = "#7c3aed";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 2 of 5 · Level 6</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>Planning & Memory</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"Planning & Memory"</strong> with beginner
