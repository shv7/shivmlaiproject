...
/* ══════════════════════════════════════════════════════════════════
   REACT FRAMEWORK
   Level 6 · Level6 AgenticAI · Lesson 5 of 5
...
function ReActFramework({ onBack }) {
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 5 of 5 · Level 6</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>ReAct Framework</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"ReAct Framework"</strong> with beginner
