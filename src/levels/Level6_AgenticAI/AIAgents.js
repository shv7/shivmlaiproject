...
/* ══════════════════════════════════════════════════════════════════
   AI AGENTS
   Level 6 · Level6 AgenticAI · Lesson 1 of 5
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function AIAgents({ onBack }) {
  const ACC = "#f97316";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 1 of 5 · Level 6</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>AI Agents</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"AI Agents"</strong> with beginner
