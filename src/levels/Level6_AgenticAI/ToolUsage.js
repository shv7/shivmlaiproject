...
/* ══════════════════════════════════════════════════════════════════
   TOOL USAGE
   Level 6 · Level6 AgenticAI · Lesson 3 of 5
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function ToolUsage({ onBack }) {
  const ACC = "#0891b2";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 3 of 5 · Level 6</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>Tool Usage</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"Tool Usage"</strong> with beginner
