...
/* ══════════════════════════════════════════════════════════════════
   LSTM
   Level 4 · Level4 DeepLearning · Lesson 6 of 7
   Status: Placeholder — ready for full lesson development
══════════════════════════════════════════════════════════════════ */

function LSTM({ onBack }) {
  const ACC = "#4f46e5";
  ...
  return (
    <div style={{wrap}}>
      <div style={{card}}>
        <div style={{badge}}>Lesson 6 of 7 · Level 4</div>
        <div style={{ fontSize:72, marginBottom:20 }}>📖</div>
        <h1 style={{h1}}>LSTM</h1>
        <p style={{desc}}>
          This lesson will cover <strong style={{ color:ACC }}>"LSTM"</strong> with beginner
